  ...
  try {
    ...
    for (const item of items) {
      ...
      if (stat.isDirectory()) {
        ...
        /\.(jpg|jpeg|png|gif|webp|svg|bmp|tiff|tif|ico|mp3|wav|ogg|m4a|3gp|flac|aac|mp4|webm|ogv|mov|mkv|avi|pdf)$/i.test(
          item,
        )
      ) {
          ...
          if (needsUpdate) {
            ...
            if (
              ...
              try {
                ...
                log.warn(
                  `⚠️  Could not optimize ${imageFile.relativePath}, copying original:`,
                  error.message,
                );
