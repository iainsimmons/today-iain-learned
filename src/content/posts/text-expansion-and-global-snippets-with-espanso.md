...
I also tried [Vicinae](https://www.vicinae.com/), which is basically a cross-platform, open-source Raycast alternative that even has some compatibility with Raycast extensions, but I found its snippet functionality to be very buggy and also not suitable for daily use.

A colleague recommended [espanso](https://espanso.org/). Being lightweight, highly configurable, and open-source, it ticked all the boxes. I gave it a shot and it's been excellent so far! It's even cross-platform so I can use it on my Linux machine too.
...
You might have also noticed the double curly braces at the end. That is how you use variables in an espanso replacement.
