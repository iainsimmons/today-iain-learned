...
- [Kulala.nvim](https://neovim.getkulala.net/): HTTP/REST client for Neovim
...
- [Vivaldi](https://vivaldi.com/): browser with a crazy amount of customisation and features, using for work on macOS
