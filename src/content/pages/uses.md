...
- [Neovim](https://neovim.io/): infinitely configurable text editor, have been using since the end of 2022. Some plugins I use:
...
- [Epomaker Split65](https://epomaker.com/products/epomaker-split-65): wireless split mechanical keyboard, with the Epomaker Flamingo switches and the [Keychron "Player" Cherry profile keycaps](https://www.keychron.com/collections/all-keycaps/products/cherry-profile-double-shot-pbt-full-set-keycaps-player)
...
![My Epomaker Split65 keyboard](../posts/attachments/epomaker-split65-with-keychron-player-keycaps.jpg)
